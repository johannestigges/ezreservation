...
/**
 * Controller for new reservation view
 *
 */
class EasyReservationControllerReservation extends JControllerForm
{
	/**
	...
	public function submit()
	{
		...
		if ($params->get('validate_session', 0))
		{
			if (JFactory::getSession()->getState() != 'active')
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_easyreservation&view=reservation&id=' . $stub, false));
...
// 		JPluginHelper::importPlugin('contact');
		...
		if ($validate === false)
		{
			...
			// Save the data in the session.
			$app->setUserState('com_easyreservation.reservation.data', $data);
		...
		{
			$this->setRedirect(JRoute::_('index.php?option=com_easyreservation&view=reservation&id=' . $stub, false), $msg);
		}
